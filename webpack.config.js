...
Encore
    ...
    .addEntry('amamentacao', './assets/scripts/amamentacao.js')
    .addEntry('selecionar_crianca', './assets/scripts/selecionar_crianca.js')
    ...
    .addEntry('kb_show', './assets/scripts/kb_show.js')
